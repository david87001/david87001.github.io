...
<tr>
	<td colspan="2" style="text-align:center;" width="128">
		<button style="font-size: 25px;">刪除</button>
	</td>
	<td colspan="2" style="text-align:center;" width="128">
...
function ccvVideo_Translation(){
	ccvSubtitle_Array = [];
	ccvSubtitle_Array.length = ccvAnimation_FrameNumber;
	for (let Translation_i = 0; Translation_i < ccvAnimation_FrameNumber; Translation_i++) {
		ccvSubtitle_Array[Translation_i] = [];
	}
	for (let Translation_i = 0; Translation_i < ccvAnimation_FrameNumber; Translation_i++){
		ccvSubtitle_Array[Translation_i][0] = 0;
		ccvSubtitle_Array[Translation_i][1] = 0;
		ccvSubtitle_Array[Translation_i][2] = "";
	}
	
	for (let Translation_i = 0; Translation_i < ccvAnimation_FrameNumber; Translation_i++){
		ccvSubtitle_Array[Translation_i][0] = Number(document.getElementById(`ccvSubtitle_Frame_${Translation_i}`).innerHTML);
		ccvSubtitle_Array[Translation_i][2] = document.getElementById(`ccvSubtitle_Text_${Translation_i}`).value;
	}
